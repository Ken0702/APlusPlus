...
// 
#ifndef SINGLETOP_AtlSgTop_combinationMemDiscR2
#define SINGLETOP_AtlSgTop_combinationMemDiscR2
...
class AtlSgTop_combinationMemDiscR2 : public AtlSelector {
  ...
  public:
    ...
    Float_t fPtJetlead_min;    // Additional minimum Pt cut for the leading jet (GeV)
    Float_t fPtJetlead_max;    // Additional maximum Pt cut for the leading jet (GeV)
    ...
    Bool_t  fOnlyOdd;   		   // Only Odd eventNumbers pass selection
  ...
  private:
    ...
    TH1F* fHist_jet_pt_raw;
    TH1F* fHist_jet_eta_raw;

    TH1F* fHist_subjet_eta_raw;
	TH1F* fHist_subjet_pt_raw;


    TH1F* fHist_met_raw;
    TH1F* fHist_mtw_raw;

    TH1F* fHist_lepton_pt_raw;
    TH1F* fHist_lepton_eta_raw;
    TH1F* fHist_dR_subjLep_raw;
    TH1F* fHist_dR_ljLep_raw;
    TH1F* fHist_dR_ljsub_raw;


  public:
    explicit AtlSgTop_combinationMemDiscR2(const char* OutputFilename);
    virtual ~AtlSgTop_combinationMemDiscR2();
  ...
  protected:
    ...
    ClassDef(AtlSgTop_combinationMemDiscR2,0) // Single-top 13 TeV s-Channel Mem Selector
};
#endif
