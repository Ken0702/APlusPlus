...
#define ATLAS_AtlEvtReaderMemR2
#ifndef ATLAS_AtlEvtReaderD3PDSgTopR2
#include <AtlEvtReaderD3PDSgTopR2.h>
#endif

class AtlEvtReaderMemR2 : public AtlEvtReaderD3PDSgTopR2 {
  ...
  public:
    ...
    ClassDefOverride(AtlEvtReaderMemR2,0) // Event reader for MemTk ntuples in run 2
};
#endif
