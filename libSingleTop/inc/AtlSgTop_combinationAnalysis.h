...
#define SINGLETOP_AtlSgTop_combinationAnalysis
...
class AtlSgTop_combinationAnalysis : public AtlSelector {
...
public:
    AtlSgTop_combinationAnalysis(const char* OutputFilename);
    virtual ~AtlSgTop_combinationAnalysis();
    ...
    ClassDef(AtlSgTop_combinationAnalysis,0) // Single-top 13 TeV combination analysis
};
#endif
