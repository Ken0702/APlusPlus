{
    ...
    // 2nd EB Meeting
    // TString OutputDir = "/rdsk/dats2/atlas/stamm/HistFactory/st_combination_dijet7_mcmcsf";
    // TString OutputDir = "/rdsk/dats2/atlas/stamm/HistFactory/st_combination_dijet7_mcmcsf2";
    TString OutputDir = "/rdsk/dats2/atlas/stamm/HistFactory/st_combination_intv04_wt_gen2included";
    ...
    // ch1_bkg1->AddShapeSystematic("JESPILEUP_OFFNPV", Systs); // removed by btagging update
    ...
    // Consider shape for systematic from common list of systematics?
    ch1_bkg4->AddShapeSystematic("Jer", Systs);
    ch1_bkg4->AddShapeSystematic("FLAVOR_COMP", Systs);
    ...
    // Add samples to channel "t-channel"
    ...
    // Add samples to channel "s-channel"
