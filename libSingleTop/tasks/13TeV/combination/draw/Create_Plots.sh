...
root -l -b -q 'draw_Signal.C("/rdsk/dats1/atlas/kkreul/combination/A++/v02_v32lj_sChannel_MC16a/sgtop_tchan_signal/AtlSgTop_tChannelAnalysis/2Jets/lnu/nominal/SgTop_s_QCDsplit_wjetsMerged/MCPlotter.root", kTRUE)'
