{
    ...
    EMCVersion mc_v = kMC16d; //v32: a-->as0 , d-->as1, e --> ms
...
//        main->ReadSampleSizeList(Form("SampleSizeLists/v15_v25lj_default_QCDJetLepton_bTag85_%s_SR.txt", MC_v_str[mc_v]));
    ...
    //v34
    ///////////
    Bool_t do_nominal = kFALSE; // v14a+d
	...
	Bool_t do_MET_MUON = kTRUE;
	Bool_t do_JER1 = kTRUE;
	Bool_t do_JER2 = kTRUE;
	Bool_t do_JET_PileUp = kTRUE;
	Bool_t do_EG = kTRUE;
