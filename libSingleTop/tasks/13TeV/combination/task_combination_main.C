    	...
    	case k34lj:
    	    	...
    	    	switch(mc_v) {
    	    	        case kMC16a:
    	    	            DSIDList.Append(Form("mc16a_%s.txt", ST_v_str[sgtop_v]));
    	    	            main->SetDataLuminosity(36184.86);
    	    	            if ( sgtop_v == k31lj || sgtop_v == k32lj || sgtop_v == k34lj)
    	    	                main->SetDataLuminosity(3219.56 + 32988.1);
    	    	            break;
    	    	        case kMC16d:
    	    	            DSIDList.Append(Form("mc16d_%s.txt", ST_v_str[sgtop_v]));
...
//        plotdir.Append(force_plotdir_append.Data());
    ...
    main->SetToolParameter("D3PDObjects", "fJetPt_min", "25.0");
    main->SetToolParameter("D3PDObjects", "fJetEta_min", "0.");
    main->SetToolParameter("D3PDObjects", "fJetEta_max", "4.5"); //was 4.5
    main->SetToolParameter("D3PDObjects", "fFwdJetPt_min", "25.");
    main->SetToolParameter("D3PDObjects", "fFwdJetEta_min", "4.5");  //was 0 
    main->SetToolParameter("D3PDObjects", "fFwdJetEta_max", "100");
    ...
    main->SetToolParameter("D3PDObjects", "fBTagger", "AtlBTag::kDL1r_77");
    ...
    main->SetToolParameter("SFTool", "fBTagWP", "AtlObjRecoScaleFactorTool::kDL1r_77");
