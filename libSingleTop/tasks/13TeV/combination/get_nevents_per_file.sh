...
#version="v02_v34lj_Run_TEST"
version="v02_v34lj_sampleSysts"
MC_ver="MC16a"
#region="SR"
#regiondir=""
...
basedir="/rdsk/${disk}/atlas/kkreul/combination/A++/${version}_${MC_ver}/${regiondir}/AtlSgTop_tChannelAnalysis/analysis/${njets}Jets/lnu/nominal"
...
do
    ...
    ntotal=$((ntotal+nevts))
    # get number of files
    nfiles=$(grep -E "^Info in <AtlSgTop_combinationAnalysis::SlaveBegin>: Registered .* input files for bookkeeping.$" $file)
