...
gridID1="GridRun_NominalOnly"
gridID2="v18"
version="v02_v32lj_${gridID1}_MC16${mc}"
indir="/rdsk/dats1/atlas/kkreul/combination/A++/${version}/rucio/Cutdownload"
ruciodir="/rdsk/dats1/atlas/kkreul/combination/A++/${version}/rucio/${gridID1}.${gridID2}"
filter=".*"

#/rdsk/dats1/atlas/kkreul/combination/A++/v02_v32lj_Grid_Test_MC16a/rucio/test
memdir=$ruciodir/mem/
appdir=$ruciodir/app/
