...
//
void task_FCNC_tZ_Signal_MtWHigher() {
    ...
    main->SetHistDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal_MtWH", user));
    main->SetJobHomeDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal_MtWH", user));
    main->SetTempDir(Form("/datc/atlas/%s/sgtop_fcnc_tZ_signal_MtWH.tmp", user));
