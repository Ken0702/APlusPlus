...
void task_FCNC_tZ_Signal_MtWLower() {
    ...
    main->SetHistDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal_MtWL", user));
    main->SetJobHomeDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal_MtWL", user));
    main->SetTempDir(Form("/datc/atlas/%s/sgtop_fcnc_tZ_signal_MtWL.tmp", user));
