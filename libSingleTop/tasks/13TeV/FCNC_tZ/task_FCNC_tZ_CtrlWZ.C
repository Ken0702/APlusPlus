void task_FCNC_tZ_CtrlWZ() {

    // ========================
    // Configure top-level task
    // ========================
    AtlTopLevelAnalysis *main = new AtlTopLevelAnalysis("AtlSgTopFCNC_tZ_CtrlWZ3L",
							"WZ 3L, CR");
    ...
    main->SetHistDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_ctrlWZ", user));
    main->SetJobHomeDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_ctrlWZ", user));
    main->SetTempDir(Form("/datc/atlas/%s/sgtop_fcnc_tZ_ctrlWZ.tmp", user));
    ...
    main->SetSelector("AtlSgTopFCNC_tZ_CtrlWZ3L");
    ...
    main->SetOutputTree("physics", "SgTopD3PD WZ CR 3L");
