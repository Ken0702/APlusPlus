void draw_Signal(const char* infile = "MCPlotter_Signal.root") {
    ...
    PlotHelper::fgRegion = new TString("Signal Region, Trilepton");
    ...
    TCanvas *c_nocuts = new TCanvas("Signal_nocuts", "FCNC tZ signal region, no cuts");
    ...
    TCanvas *c_presel = new TCanvas("Signal_presel",
				    "FCNC tZ signal region, pe-tagged");
    ...
    TCanvas *c_pretag = new TCanvas("Signal_pretag",
				    "FCNC tZ signal region, pe-tagged");
    ...
    TCanvas *c_allcuts = new TCanvas("Signal_allcuts",
				     "FCNC tZ signal region, all cuts");
