void draw_CtrlTtbar(const char* infile = "MCPlotter_CtrlTtbar.root") {
    //
    ...
    PlotHelper::fgRegion = new TString("t#bar{t} CR, Trilepton");
    ...
    TCanvas *c_nocuts = new TCanvas("CtrlTtbar_nocuts", "FCNC tZ ttbar ctrl region, no cuts");
    ...
    TCanvas *c_presel = new TCanvas("CtrlTtbar_presel",
				    "FCNC tZ ttbar ctrl region, pre-selected");
    ...
    TCanvas *c_pretag = new TCanvas("CtrlTtbar_pretag",
				    "FCNC tZ ttbar ctrl region, pe-tagged");
    ...
    TCanvas *c_allcuts = new TCanvas("CtrlTtbar_allcuts",
				     "FCNC tZ ttbar ctrl region, all cuts");
