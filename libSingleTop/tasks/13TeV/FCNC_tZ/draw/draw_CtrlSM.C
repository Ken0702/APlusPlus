void draw_CtrlSM(const char* infile = "MCPlotter_CtrlSM.root") {
    //
    ...
    PlotHelper::fgRegion = new TString("Standard Model tZ CR, Trilepton");
    ...
    TCanvas *c_nocuts = new TCanvas("CtrlSM_nocuts", "FCNC tZ SM tZ ctrl region, no cuts");
    ...
    TCanvas *c_presel = new TCanvas("CtrlSM_presel",
				    "FCNC tZ SM tZ ctrl region, pre-selected");
    ...
    TCanvas *c_pretag = new TCanvas("CtrlSM_pretag",
				    "FCNC tZ SM tZ ctrl region, pre-tagged");
    ...
    TCanvas *c_allcuts = new TCanvas("CtrlSM_allcuts",
				     "FCNC tZ SM tZ ctrl region, all cuts");
