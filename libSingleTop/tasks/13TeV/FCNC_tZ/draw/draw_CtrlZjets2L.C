void draw_CtrlZjets2L(const char* infile = "MCPlotter_CtrlZjets2L.root") {
    //
    // Create final plots for Z+jets dilepton ctrl region
    //
    TFile *f = TFile::Open(infile);
    gROOT->LoadMacro("PlotHelper.C");
    HepDataMCPlot *hep;
    PlotHelper *plot = new PlotHelper();
    PlotHelper::fgRegion = new TString("Z+jets CR, dilepton");
    ...
    TCanvas *c_nocuts = new TCanvas("CtrlZjets2L_nocuts", "Z+jets dilepton ctrl region, no cuts");
    ...
    TCanvas *c_pretag = new TCanvas("CtrlZjets2L_pretag",
				    "Z+jets dilepton ctrl region, pe-tagged");
    ...
    // Di-lepton mass
    plot = new PlotHelper(f, "PreTag/di_lepton/opp_chg/h_dilepton_Mass");
    ...
    // Di-lepton DeltaPhi
    plot = new PlotHelper(f, "PreTag/di_lepton/opp_chg/h_dilepton_DeltaPhi");
    plot->fYmin = 10;
    plot->fYmax = 6e4;
    plot->fRatioYmin = -0.5;
    plot->fRatioYmax = 2.0;
    ...
    TCanvas *c_allcuts = new TCanvas("CtrlZjets2L_allcuts",
				     "Z+jets dilepton ctrl region, all cuts");
    ...
    plot = new PlotHelper(f, "AllCuts/di_lepton/opp_chg/h_dilepton_Mass");
    plot->fXTitle = new TString("#font[52]{M}(lep,lep) [GeV]");
    plot->fYTitle = new TString("Events / 2 GeV");
    plot->fYmin = 0;
    plot->fYmax = 1e4;
    ...
    // Di-lepton DeltaPhi
    plot = new PlotHelper(f, "AllCuts/di_lepton/opp_chg/h_dilepton_DeltaPhi");
    plot->fYmin = 0.1;
    plot->fYmax = 2e5;
    plot->fRatioYmin = -0.5;
    plot->fRatioYmax = 1.8;
    ...
    // DeltaR lepton1, b-jet
    plot = new PlotHelper(f, "AllCuts/di_lepton/opp_chg/h_lep1jet_dR");
    plot->fXTitle = new TString("#Delta#font[52]{R}(lep1,b-jet)");
    plot->fYmin = 0.1;
    plot->fYmax = 4e5;
    plot->fXmin = 0.;
    plot->fXmax = 3.2;
    ...
    // DeltaR lepton2, b-jet
    plot = new PlotHelper(f, "AllCuts/di_lepton/opp_chg/h_lep2jet_dR");
    plot->fXTitle = new TString("#Delta#font[52]{R}(lep2,b-jet)");
    plot->fYmin = 0.1;
    plot->fYmax = 4e5;
    plot->fXmin = 0.;
    plot->fXmax = 3.2;
