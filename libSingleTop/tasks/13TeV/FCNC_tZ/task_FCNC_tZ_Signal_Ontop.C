...
//
void task_FCNC_tZ_Signal_Ontop() {
    ...
    main->SetHistDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal_ontop", user));
    main->SetJobHomeDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal_ontop", user));
    main->SetTempDir(Form("/datc/atlas/%s/sgtop_fcnc_tZ_signal_ontop.tmp", user));
