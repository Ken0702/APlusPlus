...
void task_FCNC_tZ_Signal() {
    ...
    main->SetHistDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal", user));
    main->SetJobHomeDir(Form("/rdsk/datm5/atlas/%s/sgtop_fcnc_tZ_signal", user));
    main->SetTempDir(Form("/datc/atlas/%s/sgtop_fcnc_tZ_signal.tmp", user));
