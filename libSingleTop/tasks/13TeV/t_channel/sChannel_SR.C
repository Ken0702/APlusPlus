{
    ...
    Bool_t is_ctrlplot = kFALSE;    // control plots for 1. or 3.
...
//    const char* plotter_scheme = "SgTop_s_QCDsplit";
    ...
    Bool_t ForceRetry        = kFALSE; // does not work for split MemTk anymore?
    ...
    ESgTopVersion sgtop_v = k29lj; // WARNING: removed QCD in ttbarsplit
    EMCVersion mc_v = kMC16d;
    ...
    //for sample systematics and their AF2 nominals (?)
//    const char* version = Form("v15_v25lj_default_samplesyst_%s", MC_v_str[mc_v]);
    //like default, but just for QCDJetLepton samples that need removal of btag requirement:
//    const char* version = Form("v15_v25lj_default_QCDJetLepton_%s", MC_v_str[mc_v]);
//    const char* version = Form("v15_v25lj_default_QCDMM_%s", MC_v_str[mc_v]);
    //use this for QCD scale factor jobs, eg noMETcut -> add this to "ext" below
//    const char* version = Form("v15_v25lj_QCD_scale_factors_%s", MC_v_str[mc_v]);
    // for control plots with AdditionalJetVeto:
//    const char* version = Form("v15_v25lj_WithAddJetVeto_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_test_submission_%s", MC_v_str[mc_v]);

    // switch to v29:
    // const char* version = Form("v16_v29lj_test_app_%s", MC_v_str[mc_v]);
...
//    const char* version = Form("v16_v29ljstar_QCDSF_noMtWcut_%s", MC_v_str[mc_v]);
    // const char* version = Form("v16_v29lj_default_v29star_%s/rucio/test_out/", MC_v_str[mc_v]);
    // v29* sample systematics
//    const char* version = Form("v16_v29lj_default_samplesyst_%s", MC_v_str[mc_v]);
    // v29* redo offline for some incomplete grid jobs
//    const char* version = Form("v16_v29lj_default_offline_ZjetsCL_%s", MC_v_str[mc_v]);
    // QCD shape systematics
    // const char* version = Form("v16_v29lj_default_QCDsyst_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_v29lj_QCDJL_TreatAllJetsAsBJets_%s", MC_v_str[mc_v]);
    // test MC weights
//    const char* version = Form("v16_v29lj_test_MCWeights_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_v29lj_default_MCWEIGHT_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_v29lj_default_4throot_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_v29lj_default_4throot_samplesyst_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_v29lj_default_4throot_QCDsyst_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_v29lj_default_logx_%s", MC_v_str[mc_v]);
    const char* version = Form("v16_v29lj_default_logx_samplesyst_%s", MC_v_str[mc_v]);
//    const char* version = Form("v16_v29lj_default_logx_QCDsyst_%s", MC_v_str[mc_v]);

    Bool_t IsManualRerun = kFALSE; // manual local rerun of failed grid jobs
    const char* ext_default = "sgtop_schan_signal";
    const char* ext = "sgtop_schan_signal";
    // const char* ext = "sgtop_schan_signal_localNominalRun"; // rerun nominal with fixed evtwriter
//    const char* ext = "sgtop_schan_signal_manual"; // run failed jobs locally
    // const char* ext = "sgtop_schan_signal_noMETcut"; // for QCD
    // const char* ext = "sgtop_schan_signal_noMtWcut"; // for QCD
    // const char* ext = "sgtop_schan_signal_noMETMtWcuts"; // for QCD
//    const char* ext = "sgtop_schan_signal_noMETMtWcuts_JLnoBtag"; // for QCD
//    const char* ext = "sgtop_schan_signal_manual364188-90"; // run failed jobs locally
    // const char* ext = "sgtop_schan_signal_barrel"; // for QCD JetLepton
//    const char* ext = "sgtop_schan_signal_endcap"; // for QCD JetLepton
//    const char* ext = "sgtop_schan_signal_noMETMtWcuts_barrel"; // for QCD
//    const char* ext = "sgtop_schan_signal_noMETMtWcuts_endcap"; // for QCD
// const char* ext = "sgtop_schan_signal_test_JetLepton_bTag85";
//    const char* ext = "sgtop_schan_signal_bTag85_noinvalid";
//    const char* ext = "sgtop_schan_signal_noBTag";
//    const char* ext = Form("sgtop_schanl_signal_EffOct2018_%s", param_string.Data());
    // const char* ext = "sgtop_schan_signal_test_JetLepton_bTag85_noMETMtWcuts";
//    const char* ext = "sgtop_schan_signal_test_JetLepton_bTag77"; // done later with MemDisc output tree
    // const char *ext = "sgtop_schan_signal_test_MC_weights";
    //    const char* ext = "sgtop_schan_signal_test_rerunWithHarderJetPtCut";
    //    const char* ext = "sgtop_schan_signal_test_rerunWithDefaultCuts";
    //    const char* ext = "sgtop_schan_signal_rerunMemTk";
    //    const char* ext = "sgtop_schan_signal_rerunMemDisc";
//    const char* ext = "sgtop_schan_signal_noinvalid";
//    const char* ext = "sgtop_schan_signal_test";
...
//    const char* GridIdSuffix = "_v25_d_test";   // some control for grid job names
    ...
    // automatic in main: append a/d, append <version>_lj, append ttbarSplit
//    main->SetDSIDList("../SampleList/SgTopDSIDs_mc16d_v29_lj_ZjetsCL.txt");
//    main->SetDSIDList("../SampleList/SgTopDSIDs_mc16d_v29_lj_Zjets.txt");
//    main->SetDSIDList("../SampleList/SgTopDSIDs_mc16d_v29_lj_ZjetsB.txt");
    // main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_QCDAMsyst.txt", mc_low.Data()));
    // main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_QCDJLsyst.txt", mc_low.Data()));
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_QCDJLnom.txt", mc_low.Data()));
    // main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_QCD_JL_JLsyst_AMsyst.txt", mc_low.Data()));
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_QCD_JL_JLsyst_AM_AMsyst.txt", mc_low.Data()));
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_top.txt", mc_low.Data()));
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_wjets.txt", mc_low.Data()));
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_ttbar.txt", mc_low.Data()));
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_samplesyst.txt", mc_low.Data()));
    ...
    if ( OverrideInput ) {
        ...
        // for rerunning over sample syst
        const char* input_version = Form("v16_v29lj_default_samplesyst_%s", MC_v_str[mc_v]);
        // // for rerunning over QCD syst
        // const char* input_version = Form("v16_v29lj_QCDJL_TreatAllJetsAsBJets_%s", MC_v_str[mc_v]);

        const char* input_ext = ext_default;
        // const char* input_ext = "sgtop_schan_signal_noinvalid";
        // const char* input_ext = "sgtop_schan_signal_test_rerunWithHarderJetPtCut";
...
//        main->ReadSampleSizeList(Form("SampleSizeLists/v15_v25lj_default_QCDJetLepton_bTag85_%s_SR.txt", MC_v_str[mc_v]));
    ...
    // // actually I implemented running two weights at same time
    // main->AddSystematic2("MCWEIGHTS_2_+_FIXEDPOS_5+Var3cUp");
    // main->AddSystematic2("MCWEIGHTS_2_+_FIXEDPOS_6+Var3cDown");
    ...
    // // what about alpha_s?
    // // need to also run for PDFSET baseline PDF, weight number 11
    // do_PDFset_PDF4LHC = kTRUE;
    // // or should I use the NNPDF3.0 error set? be flexible, add both
    // do_PDFset_NNPDF30 = kFALSE;
    // // // actually I implemented running two weights at same time -> see above
    // // main->AddSystematic2("MCWEIGHTS_2_X_muR=05,muF=05XVar3cUp");
    // // main->AddSystematic2("MCWEIGHTS_2_X_muR=20,muF=20XVar3cDown");

    // // == wjets processes ==
    // // need different MC weight names file where manually computed
    // // |w|>100 is set to 1
    // main->SetMCWeightNamesFile(
    ...
    // do_PDFset_NNPDF30_wjets = kFALSE;
    ...
    if ( do_PDFset_PDF4LHC ) {
        ...
        // the names are different for schan, wt, ttbar compared to tchan
        // -> therefore use the positions
        // however ttbar is shifted by 3
    ...
    if ( do_PDFset_NNPDF30 ) {
        // the names are different for schan, wt, ttbar compared to tchan
        // TODO: use shift by 3 in case we ever use NNPDF30
    ...
    if ( mode == kCut ) {
        if ( UseDefaultCuts ) {
            ...
            // v15: v14 and reduce output for some size reduction
            // in v29lj this does not work anymore -> function removed
            // main->SetCut("fEvtWriterReduceOutput", "kTRUE");
            ...
            // // minimal cuts: MET_min = 25, MtW_min=25, ==2 btags
            // // main->SetCut("fPt_Jet_min", "30."); //
            // main->SetCut("fPt_LeadingJet_min", "80.");//
            // // main->SetCut("fApplyDileptonVeto", "kTRUE");//
            // main->SetCut("fMET_min", "25.");
            // main->SetCut("fMtW_minPre", "25.");
            // // main->SetCut("fMtW_min", "25."); //
            // // main->SetCut("fAdditionalJetVeto", "kTRUE"); // for MEM
            // main->SetCut("fNBTags_min", "2");
            // main->SetCut("fNBTags_max", "2");
            // // main->SetCut("fLeadingJetIsBTagged", "kFALSE");//
            // // main->SetCut("fMCTruthStudy", "kFALSE"); //
            // main->SetCut("fDoReconstructTop", "kTRUE");
            // main->SetCut("fCopyCutflowHistograms", "kTRUE");

            // // default without b-tag requirement for JetLepton statistics
            // main->SetCut("fPt_Jet_min", "30.");
            // main->SetCut("fPt_LeadingJet_min", "40.");
            // main->SetCut("fApplyDileptonVeto", "kTRUE");
            // main->SetCut("fMET_min", "35.");
            ...
            // use different b-tags
            // main->SetToolParameter("D3PDObjects", "fBTagger", "AtlBTag::kMV2c10_77");
            // main->SetToolParameter("SFTool", "fBTagWP", "AtlObjRecoScaleFactorTool::kMV2c10_77");

            // // check BDT and new cutflow, without add jet veto
            // // also just run for BDT, (v13)+v14
            // main->SetCut("fPt_Jet_min", "30.");
            // main->SetCut("fPt_LeadingJet_min", "40.");
            // main->SetCut("fApplyDileptonVeto", "kTRUE");
            // main->SetCut("fMET_min", "35.");
            ...
            // main->SetCut("fMCTruthStudy", "kFALSE");
            // main->SetCut("fDoReconstructTop", "kTRUE");
            // main->SetCut("fCopyCutflowHistograms", "kFALSE");

            // v14 different tests for additionaljetveto with the above "check BDT..." lines:
            // 0. use default without veto
            // // 1. turn veto on again
            // main->SetCut("fAdditionalJetVeto", "kTRUE"); // for MEM
            // // 2. turn veto on only for pt region
            // main->SetCut("fAdditionalJetVetoPt", "kTRUE");
            // main->SetCut("fAdditionalJetVetoEta", "kFALSE");
            // // 3. turn veto on only for eta region
            // main->SetCut("fAdditionalJetVetoPt", "kFALSE");
            // main->SetCut("fAdditionalJetVetoEta", "kTRUE");

            // v14 and v15 defaults:
            main->SetCut("fPt_Jet_min", "30.");
            main->SetCut("fPt_LeadingJet_min", "40.");
            main->SetCut("fApplyDileptonVeto", "kTRUE");
            main->SetCut("fMET_min", "35.");
            ...
            main->SetCut("fMCTruthStudy", "kFALSE");
            main->SetCut("fDoReconstructTop", "kTRUE");
            // // v15 reduce output for some size reduction
            // main->SetCut("fEvtWriterReduceOutput", "kTRUE");
            ...
            // main->SetCut("fNBTags_min", "0");
            // main->SetCut("fDoReconstructTop", "kFALSE");
            // // 3. neither MET nor MtW cut, leave jetlepton at 2bjets
            // main->SetCut("fMET_min", "0.");
            // main->SetCut("fMtW_min", "0.");
            // main->SetCut("fMtW_minPre", "0.");
            // main->SetCut("fDoReconstructTop", "kFALSE");
            // // 4. default but lepton restricted to barrel region
            // main->SetCut("fEta_Lepton_max", "1.45");
            // main->SetCut("fDoReconstructTop", "kFALSE");
            // 5. default but lepton restricted to endcap region
            // main->SetCut("fEta_Lepton_min", "1.45");
            // main->SetCut("fDoReconstructTop", "kFALSE");

            // // v15 QCD more JetLepton stat:
            // // 1. using btag WP 85% for higher statistics
            // main->SetCut("fDoReconstructTop", "kFALSE");
            ...
            // // 2. without MET and MTW cut for normalization
            // main->SetCut("fDoReconstructTop", "kFALSE");
            // main->SetToolParameter("D3PDObjects", "fBTagger", "AtlBTag::kMV2c10_85");
            // main->SetToolParameter("SFTool", "fBTagWP",
            //                        "AtlObjRecoScaleFactorTool::kMV2c10_85");
            ...
            // main->SetCut("fMtW_min", "0.");
            // main->SetCut("fMtW_minPre", "0.");
            // // 3. use no btag requirement
            // main->SetCut("fDoReconstructTop", "kFALSE");
            // main->SetCut("fNBTags_min", "0");
            // // 4. no MET or MtW cuts, no btag requirement
            // main->SetCut("fDoReconstructTop", "kFALSE");
            // main->SetCut("fNBTags_min", "0");
            // main->SetCut("fMET_min", "0.");
            // main->SetCut("fMtW_min", "0.");
            ...
            // // v15 test rerunning over previous samples
            // // 1. simple Jet Pt cut, leave everything else, no cuts, no reconstruction
            // main->SetCut("fPt_Jet_min", "50.");
            // main->SetCut("fEvtWriterCloneOnly", "kTRUE");

            // // v15 Use AddJetVeto again
            // main->SetCut("fAdditionalJetVeto", "kTRUE");
            // main->SetCut("fDoReconstructTop", "kFALSE");

            // // QCD MM: split in el/mu channel
            // main->SetCut("fDoReconstructTop", "kFALSE");
            // if ( channel.EqualTo("el") ) {
            //     main->SetToolParameter("D3PDObjects", "fLepChannel",
            //                            "AtlSelector::kElectron");
            // } else if ( channel.EqualTo("mu") ) {
            //     main->SetToolParameter("D3PDObjects", "fLepChannel",
            //                            "AtlSelector::kMuon");
            // }
...
//        main->SetCut("fPt_LeadingJet_min", "35.");
        main->SetCut("fApplyDileptonVeto", "kTRUE");
//        main->SetCut("fMET_min", "15.");
...
//        main->SetCut("fLeadingJetIsBTagged", "kFALSE");
        ...
        // main->SetToolParameter("D3PDObjects", "fElectronPt_min", "20.");
        // main->SetToolParameter("D3PDObjects", "fMuonPt_min", "20.");
