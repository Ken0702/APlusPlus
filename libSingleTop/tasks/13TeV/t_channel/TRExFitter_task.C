...
//////////////////////// TCHANNEL
 TString filepath("/rdsk/datm7/atlas/kkreul/13TeV_t_channel/A++/v22_v29lj_NoMETCutForQCDFit_MC16d/sgtop_tchan_signal/AtlSgTop_tChannelAnalysis/2Jets/lnu/nominal/SgTop_s_QCDsplit_wjetsMerged");  
