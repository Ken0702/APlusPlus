...
version="v16_v29lj_default_samplesyst_MC16${mc}"
...
ruciodir="/rdsk/datm8/atlas/kaphle/13TeV_s_channel/${version}/rucio/${gridID1}.${gridID2}"
appdir=$ruciodir/app/
memdir=$ruciodir/mem/
# appoutdir="/rdsk/datm8/atlas/kaphle/13TeV_s_channel/v16_v29lj_default_v29star_MC16a/rucio/test_out"
appoutdir="/rdsk/datm8/atlas/kaphle/13TeV_s_channel/${version}/${region_out}/AtlSgTop_sChannelAnalysis"
