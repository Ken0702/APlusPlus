...
//    const char* version = Form("v16_v29lj_test_MCWeights_%s", MC_v_str[mc_v]);
    //const char* version = Form("v16_sChannelCode_%s", MC_v_str[mc_v]);
    const char* version = Form("v00_v29lj_MemTK_Test_%s", MC_v_str[mc_v]);
...
//    const char* ext = "sgtop_schan_signal_test";
    ...
    //                           user, version, ext);
   //const char* anadir = Form("/rdsk/datm7/atlas/%s/13TeV_t_channel/%s/%s", user, version, ext);
...
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v25_lj_QCDJetLepton.txt", mc_low.Data()));
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v25_lj_QCDMM.txt", mc_low.Data()));
    // main->SetDSIDList(DSIDList.ReplaceAll(".txt", "_withoutDATA.txt"));
    // main->SetDSIDList("../SampleList/SgTopDSIDs_mc16a_v21_lj_withoutDATA.txt");
    // main->SetDSIDList("../SampleList/SgTopDSIDs_mc16d_v21_lj_withoutDATA.txt");
    // main->SetDSIDList("../SampleList/SgTopDSIDs_mc16a_v23_lj_ttbarSplit.txt");
    // main->SetDSIDList("../SampleList/SgTopDSIDs_mc16a_v23_lj_ttbarSplit_tempwithoutsomesamples.txt");
    // main->SetDSIDList("../SampleList/SgTopDSIDs_mc16a_v23_lj_ttbarSplit_tempwithoutsomesamples.txt");
...
//    main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_wjets.txt", mc_low.Data()));
   ...
   // main->SetDSIDList(Form("../SampleList/SgTopDSIDs_%s_v29_lj_OnlyTchan.txt", mc_low.Data()));
    ...
    if ( OverrideInput ) {
        ...
        const char* input_anadir = Form("/rdsk/datm7/atlas/%s/13TeV_t_channel/%s/%s",
