{
    ...
    // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //
    // This file is used by task_sChannel_SR.C and the
...
//        plotdir.Append(force_plotdir_append.Data());
    ...
    if ( UseOutputTree )
        main->SetOutputTree("physics", "SgTopD3PD s-channel SR");
    ...
    // Select selector
    if ( mode == kMemDisc ) {
        main->SetSelector("AtlSgTop_sChannelMemDiscR2");
    } else {
    ...
    main->SetToolParameter("D3PDObjects", "fJetsAuthor",
        ...
        main->SetToolParameter("D3PDObjects", "fFwdJetEta_min", "4.5");
        ...
        main->SetToolParameter("SFTool", "fBTagWP",
                               "AtlObjRecoScaleFactorTool::kMV2c10_60");
    ...
    main->SetToolParameter("D3PDObjects", "fBTagWeight_min", "0.5");
