...
void roc_curve() {
    ...
    TString filename_sig("/rdsk/dats5/atlas/kaphle/13TeV_s_channel/v14_v23lj_default/sgtop_schan_signal/MemDisc/SgTop_s_wjetsMerged/combined/sgtop_sChannel.root");
    TString filename_ttbar("/rdsk/dats5/atlas/kaphle/13TeV_s_channel/v14_v23lj_default/sgtop_schan_signal/MemDisc/SgTop_s_wjetsMerged/combined/ttbar.root");
    TString filename_wjets("/rdsk/dats5/atlas/kaphle/13TeV_s_channel/v14_v23lj_default/sgtop_schan_signal/MemDisc/SgTop_s_wjetsMerged/combined/wjets.root");
    TString filename_bkg("/rdsk/dats5/atlas/kaphle/13TeV_s_channel/v14_v23lj_default/sgtop_schan_signal/MemDisc/SgTop_s_wjetsMerged/combined/bkg.root");
