...
void roc_curve() {
    ...
    // combined files
    TString savename("ROC_MEM_v23lj_combined.pdf");
    TString filename_sig(" /rdsk/dats1/atlas/kkreul/combination/A++/v02_v32lj_GridRun_NominalOnly_MC16a/sgtop_schan_signal/AtlSgTop_tChannelAnalysis/MemDisc/2Jets/lnu/nominal/SgTop_s_QCDsplit_wjetsMerged/adapted_for_trexfitter_allhist/sgtop_sChannel.root");
    TString filename_ttbar(" /rdsk/dats1/atlas/kkreul/combination/A++/v02_v32lj_GridRun_NominalOnly_MC16a/sgtop_schan_signal/AtlSgTop_tChannelAnalysis/MemDisc/2Jets/lnu/nominal/SgTop_s_QCDsplit_wjetsMerged/adapted_for_trexfitter_allhist/ttbar.root");
    TString filename_wjets(" /rdsk/dats1/atlas/kkreul/combination/A++/v02_v32lj_GridRun_NominalOnly_MC16a/sgtop_schan_signal/AtlSgTop_tChannelAnalysis/MemDisc/2Jets/lnu/nominal/SgTop_s_QCDsplit_wjetsMerged/adapted_for_trexfitter_allhist/wjets.root");
    TString filename_bkg(" /rdsk/dats1/atlas/kkreul/combination/A++/v02_v32lj_GridRun_NominalOnly_MC16a/sgtop_schan_signal/AtlSgTop_tChannelAnalysis/MemDisc/2Jets/lnu/nominal/SgTop_s_QCDsplit_wjetsMerged/adapted_for_trexfitter_allhist/bkg.root");
    ...
    gr_ttbar->GetXaxis()->SetTitle("signal efficiency");
    gr_ttbar->GetYaxis()->SetTitle("background rejection (1-eff)");
