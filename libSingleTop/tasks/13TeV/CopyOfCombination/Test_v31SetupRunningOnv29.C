{
    ...
    enum ESgTopVersion { k15lj, k20lj, k21lj, k23lj, k24lj, k25lj, k29lj, k31lj};
    static const char* ST_v_str[8] = { "v15_lj", "v20_lj", "v21_lj", "v23_lj", "v24_lj", "v25_lj", "v29_lj", "v31_lj"};
...
//    const char* plotter_scheme = "SgTop_s_splitall";
   ...
   // const char* version = Form("v22_%s_NoMETCutForQCDFit_%s",sgtop_v, MC_v_str[mc_v]);
    const char* version = Form("v01_v29lj_Runv31CodeOnv29_%s", MC_v_str[mc_v]);
    //const char* version = Form("v01_v31lj_Testv31_TestNBTagCut_%s", MC_v_str[mc_v]);
