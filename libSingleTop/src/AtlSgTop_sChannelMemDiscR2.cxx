...
// 
#include <AtlSgTop_sChannelMemDiscR2.h>
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw_eplus[AtlSgTop_sChannelMemDiscR2::fgNBins_raw_eplus+1]= {
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw_eminus[AtlSgTop_sChannelMemDiscR2::fgNBins_raw_eminus+1]= {
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw_muplus[AtlSgTop_sChannelMemDiscR2::fgNBins_raw_muplus+1]= {
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw_muminus[AtlSgTop_sChannelMemDiscR2::fgNBins_raw_muminus+1]= {
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw1[AtlSgTop_sChannelMemDiscR2::fgNBins_raw1+1]= {
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw2[AtlSgTop_sChannelMemDiscR2::fgNBins_raw2+1]= {
    ...
    1.00000000};
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw3[AtlSgTop_sChannelMemDiscR2::fgNBins_raw3+1]= {
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw4[AtlSgTop_sChannelMemDiscR2::fgNBins_raw4+1]= {
...
const Double_t AtlSgTop_sChannelMemDiscR2::fgBinEdges_raw5[AtlSgTop_sChannelMemDiscR2::fgNBins_raw5+1]= {
...
AtlSgTop_sChannelMemDiscR2::AtlSgTop_sChannelMemDiscR2(const char* OutputFile) :
...
AtlSgTop_sChannelMemDiscR2::~AtlSgTop_sChannelMemDiscR2() {
    //
    // Default destructor
    //
...
void AtlSgTop_sChannelMemDiscR2::Clear(Option_t */*option*/) {
    //
...
void AtlSgTop_sChannelMemDiscR2::Begin(TTree *tree) {
    //
    // Begin analysis job
    //
...
void AtlSgTop_sChannelMemDiscR2::SetBranchStatus() {
    //
...
void AtlSgTop_sChannelMemDiscR2::SetCutDefaults() {
    //
...
void AtlSgTop_sChannelMemDiscR2::BookHistograms() {
    //
    // Book histograms
    //    
...
void AtlSgTop_sChannelMemDiscR2::BookHistogramsMemLogLikelihood(AtlHistogramTool *htool,
                                                                const char *subdir) {
    //
...
void AtlSgTop_sChannelMemDiscR2::FillHistogramsMemLogLikelihood(AtlHistogramTool *htool,
                                                                Double_t W,
                                                                const char *subdir) {
    //
...
Bool_t AtlSgTop_sChannelMemDiscR2::ProcessPreCut() {
    //
...
Bool_t AtlSgTop_sChannelMemDiscR2::ProcessCut() {
    //
...
void AtlSgTop_sChannelMemDiscR2::FillHistograms() {
    //
    // Fill histograms
    //
...
void AtlSgTop_sChannelMemDiscR2::InitEvent() {
    //
...
void AtlSgTop_sChannelMemDiscR2::Print(Option_t */*option*/) const {
    //
...
void AtlSgTop_sChannelMemDiscR2::Terminate() {
    //
