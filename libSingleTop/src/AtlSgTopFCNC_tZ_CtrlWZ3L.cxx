...
#include <AtlSgTopFCNC_tZ_CtrlWZ3L.h>
#endif

#ifndef __CINT__
ClassImp(AtlSgTopFCNC_tZ_CtrlWZ3L);
#endif
...
AtlSgTopFCNC_tZ_CtrlWZ3L::AtlSgTopFCNC_tZ_CtrlWZ3L(const char* OutputFileName) :
...
AtlSgTopFCNC_tZ_CtrlWZ3L::~AtlSgTopFCNC_tZ_CtrlWZ3L() {
    //
    // Default destructor
    //
    delete fHistsNoCuts;
...
void AtlSgTopFCNC_tZ_CtrlWZ3L::SetCutDefaults() {
    //
...
void AtlSgTopFCNC_tZ_CtrlWZ3L::Print(Option_t *option) const {
    //
    // Print user analysis configuration
    //
    cout << endl
	 << "========================================================" << endl
	 << "  Atlas Single-Top FCNC tZ Selector : WZ Control Region " << endl
	 << "========================================================" << endl
	 << endl;
...
Bool_t AtlSgTopFCNC_tZ_CtrlWZ3L::ProcessCut() {
    //
    // Event selection
    //
...
void AtlSgTopFCNC_tZ_CtrlWZ3L::BookHistograms() {
    //
    // Book histograms
    //
