{
    ...
    TString OutputDir = "/rdsk/dats2/atlas/stamm/HistFactory/CtrlDistFit/CtrlWjets/";
    ...
    AtlHistFactoryMeasurement *meas = new AtlHistFactoryMeasurement("sChannel_Analysis_CtrlDistSR",
								    "s-Channel Analysis Ctrl Distribution Fit, CtrlWjets Region",
								    OutputDir.Data());
    // Fit real data
    ...
    // CtrlWjets channel e+jets
    TString CtrlWjetsDir_e_noveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_wjets_noveto/AtlSgTop_sChannelAnalysis/2Jets/enu/";
    AtlHistFactoryChannel *ch1 = new AtlHistFactoryChannel("CtrlWjets_e_noveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlWjetsDir_e_noveto);
    ...
    // CtrlWjets channel mu+jets
    TString CtrlWjetsDir_mu_noveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_wjets_noveto/AtlSgTop_sChannelAnalysis/2Jets/munu/";
    AtlHistFactoryChannel *ch2 = new AtlHistFactoryChannel("CtrlWjets_mu_noveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlWjetsDir_mu_noveto);
    // Only nominal
    ...
    // CtrlWjets channel l+jets
    TString CtrlWjetsDir_lnu_noveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_wjets_noveto/AtlSgTop_sChannelAnalysis/2Jets/lnu/";
    AtlHistFactoryChannel *ch3 = new AtlHistFactoryChannel("CtrlWjets_lnu_noveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlWjetsDir_lnu_noveto);
    // Only nominal
    ...
    // CtrlWjets channel e+jets
    TString CtrlWjetsDir_e_dileptonveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_wjets_dileptonveto/AtlSgTop_sChannelAnalysis/2Jets/enu/";
    AtlHistFactoryChannel *ch4 = new AtlHistFactoryChannel("CtrlWjets_e_dileptonveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlWjetsDir_e_dileptonveto);
    // no shape discriminants needed
    ...
    // CtrlWjets channel mu+jets
    TString CtrlWjetsDir_mu_dileptonveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_wjets_dileptonveto/AtlSgTop_sChannelAnalysis/2Jets/munu/";
    AtlHistFactoryChannel *ch5 = new AtlHistFactoryChannel("CtrlWjets_mu_dileptonveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlWjetsDir_mu_dileptonveto);
    // Only nominal
    ...
    // CtrlWjets channel l+jets
    TString CtrlWjetsDir_lnu_dileptonveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_wjets_dileptonveto/AtlSgTop_sChannelAnalysis/2Jets/lnu/";
    AtlHistFactoryChannel *ch6 = new AtlHistFactoryChannel("CtrlWjets_lnu_dileptonveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlWjetsDir_lnu_dileptonveto);
    // Only nominal
