{
    ...
    TString OutputDir = "/rdsk/dats2/atlas/stamm/HistFactory/CtrlDistFit/CtrlTtbar/";
    ...
    AtlHistFactoryMeasurement *meas = new AtlHistFactoryMeasurement("sChannel_Analysis_CtrlDistSR",
								    "s-Channel Analysis Ctrl Distribution Fit, CtrlTtbar Region",
								    OutputDir.Data());
    // Fit real data
    ...
    // CtrlTtbar channel e+jets
    TString CtrlTtbarDir_e_noveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_ttbar_noveto/AtlSgTop_sChannelAnalysis/4Jets/enu/";
    AtlHistFactoryChannel *ch1 = new AtlHistFactoryChannel("CtrlTtbar_e_noveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlTtbarDir_e_noveto);
    ...
    // CtrlTtbar channel mu+jets
    TString CtrlTtbarDir_mu_noveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_ttbar_noveto/AtlSgTop_sChannelAnalysis/4Jets/munu/";
    AtlHistFactoryChannel *ch2 = new AtlHistFactoryChannel("CtrlTtbar_mu_noveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlTtbarDir_mu_noveto);
    // Only nominal
    ...
    // CtrlTtbar channel l+jets
    TString CtrlTtbarDir_lnu_noveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_ttbar_noveto/AtlSgTop_sChannelAnalysis/4Jets/lnu/";
    AtlHistFactoryChannel *ch3 = new AtlHistFactoryChannel("CtrlTtbar_lnu_noveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlTtbarDir_lnu_noveto);
    // Only nominal
    ...
    // CtrlTtbar channel e+jets
    TString CtrlTtbarDir_e_dileptonveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_ttbar_dileptonveto/AtlSgTop_sChannelAnalysis/4Jets/enu/";
    AtlHistFactoryChannel *ch4 = new AtlHistFactoryChannel("CtrlTtbar_e_dileptonveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlTtbarDir_e_dileptonveto);
    // no shape discriminants needed
    ...
    // CtrlTtbar channel mu+jets
    TString CtrlTtbarDir_mu_dileptonveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_ttbar_dileptonveto/AtlSgTop_sChannelAnalysis/4Jets/munu/";
    AtlHistFactoryChannel *ch5 = new AtlHistFactoryChannel("CtrlTtbar_mu_dileptonveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlTtbarDir_mu_dileptonveto);
    // Only nominal
    ...
    // CtrlTtbar channel l+jets
    TString CtrlTtbarDir_lnu_dileptonveto = "/rdsk/datm7/atlas/stamm/8TeV_s_channel/v15/ctrl_ttbar_dileptonveto/AtlSgTop_sChannelAnalysis/4Jets/lnu/";
    AtlHistFactoryChannel *ch6 = new AtlHistFactoryChannel("CtrlTtbar_lnu_dileptonveto",
     							   "bTagged/Sel/h_sel_MtW",
    							   CtrlTtbarDir_lnu_dileptonveto);
    // Only nominal
    ...
    meas->AddChannel(ch1); // no veto
    meas->AddChannel(ch2); //
    meas->AddChannel(ch3); // 
    meas->AddChannel(ch4); // di-lepton veto
    meas->AddChannel(ch5); //
    meas->AddChannel(ch6); //
