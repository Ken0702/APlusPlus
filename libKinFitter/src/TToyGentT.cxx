...
Bool_t TToyGentT::doToyExperiments( Int_t nbExperiments ) {
  ...
  TFitConstraintMBW MConsWhad( "MassConstraint Whad", "Mass-Constraint Whad", 0, WhadM, 2.14);
  MConsWhad.addParticles1( _Whad_d1, _Whad_d2 );

  TFitConstraintMBW MConsTophad( "MassConstraint Tophad", "Mass-Constraint Tophad", 0, TophadM, 2.);
  MConsTophad.addParticles1( _Whad_d1, _Whad_d2, _Tophad_d2 );

  TFitConstraintMBW MConsWlep( "MassConstraint Wlep", "Mass-Constraint Wlep", 0, WlepM, 2.14);
  MConsWlep.addParticles1( _Wlep_d1, _Wlep_d2 );

  TFitConstraintMBW MConsToplep( "MassConstraint Toplep", "Mass-Constraint Toplep", 0, ToplepM, 2.);
  ...
  if( _printPartIni ) {
    ...
    cout << "----------------------------------" << endl ;
    _iniWhad_d1->printParticle();
    _iniWhad_d2->printParticle();
    _iniTophad_d2->printParticle();
    _iniWlep_d1->printParticle();
    _iniWlep_d2->printParticle();
    _iniToplep_d2->printParticle();
    cout << endl << endl;
  }
  ...
  for (int i = 0; i < nbExperiments; i++) {
    ...
    if( _printSmearedPartBefore ) {
      ...
      cout << "-------------------------------------------------------" << endl;
      _Whad_d1->printParticle();
      _Whad_d2->printParticle();
      _Tophad_d2->printParticle();
      _Wlep_d1->printParticle();
      _Wlep_d2->printParticle();
      _Toplep_d2->printParticle();
    }
